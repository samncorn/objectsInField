...
def main():
    ...
    head=head+"Ast-Sun-x(km) "
    head=head+"Ast-Sun-y(km) "
    head=head+"Ast-Sun-z(km) "
    head=head+"Ast-Sun-xRate(km/sec) "
    head=head+"Ast-Sun-yRate(km/sec) "
    head=head+"Ast-Sun-zRate(km/sec) "
